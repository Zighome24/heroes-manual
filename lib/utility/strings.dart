...
const List<String> organizationTitles = [
  "Georgia Coalition Against Domestic Violence (GCADV) - https://gcadv.org/ ",
  "Georgia Commision on Family Violence (GCFV) - https://gcfv.georgia.gov/ ",
  ...
  "Center for Disease Control and Prevention (CDC) : Preventing Intimate "
      "Partner Violence - https://www.cdc.gov/violenceprevention/intimatepartnerviolence/fastfact.html",
  "Office on Women’s Health - https://www.womenshealth.gov/relationships-and-safety ",
  "U.S. Department of Justice - https://www.justice.gov/ovw/domestic-violence",
  "Americans Overseas Domestic Violence Crisis Center - http://www.866uswomen.org",
  "Georgia Domestic Violence Shelters - https://gcadv.org/get-help/find-a-domestic-violence-center-near-you/",
  "Greatist - https://greatist.com/happiness/stop-domestic-violence-organizations",
  "Family Violence Prevention Fund - https://www.endabuse.org",
  "Men Stopping Violence - htpps://www.menstoppingviolence.org",
  ...
  "National Clearinghouse for the Defense of Battered Women - https://www.ncdbw.org/",
  "National Network to End Domestic Violence - https://www.bwjp.org/resource-center/resource-results/national-network-to-end-domestic-violence.html",
];